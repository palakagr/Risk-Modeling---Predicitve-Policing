...
```
The above two scatter plots show that as the count of drug or domestiv violence counts increase, so does the count of assaults. To avoid multicollinearity the variables were lefft out.      
